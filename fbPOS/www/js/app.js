    ...
    $ionicPlatform.ready(function() {
        ...
        $ionicPlatform.registerBackButtonAction(function(e) {
            if ($rootScope.backButtonPressedOnceToExit) {
                console.log('register back button action into 1');
                ionic.Platform.exitApp();
            } else if ($ionicHistory.backView()) {
                console.log('register back button action into 2');
                ...
                console.log('register back button action into 3');
            ...
            console.log('register back button action into 4');
            e.preventDefault();
            return false;
        }, 101);
    });
